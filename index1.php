...
<body>
    ...
    <div class="wellness-our-benefit bg-radius-section">
        <div class="container">
            <div class="row">
                ...
                <div class="section-title text-center">
                    ...
                    <p class="wow fadeInUp" data-wow-delay="0.2s">At Prana, longevity isn’t just about adding years—it’s
                ...
                <div class="col-lg-6">
                    <div class="wellness-our-benefit-content">
                        <div class="section-title text-center">
                            <h3 class="text-anime-style-2" data-cursor="-opaque">Slowing & Reversing Biological <br>
                                Aging
                            </h3>
                            <p class="wow fadeInUp text-justify" data-wow-delay="0.25s">Aging is driven by oxidative
                                stress,
                                mitochondrial decline, and chronic inflammation. Our evidence-based protocols—including
                                hyperbaric oxygen therapy and advanced cellular nutrition—target these mechanisms at
                                their source. By restoring cellular energy (ATP production), reducing senescent cell
                                load, and improving systemic circulation, we promote measurable reductions in biological
                                age markers.
                            </p>
                            <img class="ig-thumbs mt-3" src="images/home/insta.webp" alt="Video thumbnail">
                        </div>
                        <!-- <div class="ig-wrap" id="igPlayer" data-ig-url="https://www.instagram.com/p/C3Hw1TeR1xX/">
                            
                            <img class="ig-thumb" src="images/home/insta.webp" alt="Video thumbnail">
                            <div class="ig-play" aria-hidden="true"></div>
                        </div> -->
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="wellness-our-benefit-content">
                        <div class="section-title text-center">
                            <h3 class="text-anime-style-2" data-cursor="-opaque">Activating Cellular Repair and Genetic
                                Resilience

                            </h3>
                            <p class="wow fadeInUp" data-wow-delay="0.25s">Longevity science now focuses on epigenetic
                                repair—the ability to influence gene expression for optimal health. Our therapies
                                stimulate angiogenesis, DNA repair pathways, and stem cell activity, while modulating
                                methylation patterns linked to aging. This results in enhanced tissue regeneration,
                                improved cognitive function, and long-term resilience—transforming the way your body
                                adapts and heals.
                            </p>
                            <img class="ig-thumbs mt-3" src="images/home/insta.webp" alt="Video thumbnail">
                        </div>
                        <!-- <div class="ig-wrap" id="igPlayer1" data-ig-url="https://www.instagram.com/p/C3Hw1TeR1xX/">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <div class="testimonial-header">
                                            ...
                                            <div class="testimonial-content">
                                                <p>I had been struggling with a non-healing wound for months. After HBOT at Prana, my recovery accelerated in ways I didn’t think possible. Truly life-changing.</p>
                                            </div>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <div class="testimonial-header">
                                            ...
                                            <div class="testimonial-content">
                                                <p>As a footballer, recovery is everything. HBOT at Prana has helped me bounce back faster, reduce inflammation, and stay at peak performance.
                                                </p>
                                            </div>
                                        </div>
                                        <div class="testimonial-body">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <div class="testimonial-header">
                                            ...
                                            <div class="testimonial-content">
                                                <p>I’ve always been curious about wellness therapies. Prana gave me an experience that was both scientific and holistic. I feel more energetic and clear-headed every day.
                                                </p>
                                            </div>
                                        </div>
                                        <div class="testimonial-body">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <div class="testimonial-header">
                                            ...
                                            <div class="testimonial-content">
                                                <p>During my cancer journey, HBOT at Prana made my treatments more tolerable and improved my overall quality of life. It gave me strength when I needed it most.</p>
                                            </div>
                                        </div>
                                        <div class="testimonial-body">
                                            <div class="author-image d-none">
                                 ...
                                 <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <div class="testimonial-header">
                                            ...
                                            <div class="testimonial-content">
                                                <p>I believe prevention is better than cure. At Prana, I’ve found therapies that not only make me feel younger but also give me confidence about living longer, healthier.</p>
                                            </div>
                                        </div>
                                        <div class="testimonial-body">
                                            <div class="author-image d-none">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item wow fadeInUp">
                        <div class="post-featured-image">
                            <figure>
                                <a href="synergizing-hyperbaric-therapy-and-neurorehabilitation-for-optimal-healing.php" class="image-anime" data-cursor-text="View">
                        ...
                        <div class="post-item-content">
                            ...
                            <div class="post-item-body">
                                <h2><a href="synergizing-hyperbaric-therapy-and-neurorehabilitation-for-optimal-healing.php">Synergizing Hyperbaric Therapy and Neurorehabilitation for Optimal Healing</a></h2>
                            </div>
                            <div class="post-item-footer">
                                <a href="synergizing-hyperbaric-therapy-and-neurorehabilitation-for-optimal-healing.php" class="readmore-btn">read more</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item wow fadeInUp" data-wow-delay="0.25s">
                        <div class="post-featured-image">
                            <figure>
                                <a href="revolutionizing-healing-with-hyperbaric-oxygen-therapy-for-everyone.php" class="image-anime" data-cursor-text="View">
                        ...
                        <div class="post-item-content">
                            ...
                            <div class="post-item-body">
                                <h2><a href="revolutionizing-healing-with-hyperbaric-oxygen-therapy-for-everyone.php">Revolutionizing Healing with Hyperbaric Oxygen Therapy for Everyone</a>
                                </h2>
                            </div>
                            <div class="post-item-footer">
                                <a href="revolutionizing-healing-with-hyperbaric-oxygen-therapy-for-everyone.php" class="readmore-btn">read more</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item wow fadeInUp" data-wow-delay="0.5s">
                        <div class="post-featured-image">
                            <figure>
                                <a href="neurorehabilitation-restoring-brain-health-enhancing-recovery.php" class="image-anime" data-cursor-text="View">
                        ...
                        <div class="post-item-content">
                            ...
                            <div class="post-item-body">
                                <h2><a href="neurorehabilitation-restoring-brain-health-enhancing-recovery.php">Neurorehabilitation: The Key to Restoring Brain Health and Enhancing Recovery</a></h2>
                            </div>
                            <div class="post-item-footer">
                                <a href="neurorehabilitation-restoring-brain-health-enhancing-recovery.php" class="readmore-btn">read more</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="contact-info-item wow fadeInUp col-lg-6 col-12 mb-5" data-wow-delay="0.75s">
                                ...
                                <div class="contact-info-content">
                                    ...
                                    <p>G 10, Ground Floor, Plot no.297, 298, Vitthal Rukmani CHS Ltd., Katrak Road, Ram
                                        Mandir, Wadala, Mumbai-400031. <br> Contact no - 8369330734, 9320065511
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="contact-info-item wow fadeInUp col-lg-6 col-12 mb-5" data-wow-delay="1s">
                                ...
                                <div class="contact-info-content">
                                    ...
                                    <p>Garava Building, Plot no. E 27, 1st FLoor, Opp. Kendriya Vihar, Prime Mall Lane,
                                        Sector 12, Kharghar - 410210. <br> Contact no - 8369330734, 9320065511
                                    </p>
                                </div>
                            </div>
                            <div class="contact-info-item wow fadeInUp col-lg-6 col-12 mb-5" data-wow-delay="1s">
                                ...
                                <div class="contact-info-content">
                                    ...
                                    <p>Kiran Multi Super speciality Hospital, Vasta Devdi Road, near Sumul Dairy Road,
                                        Katargam, Surat, Gujarat - 395004. <br> Contact no - 9320065511
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="contact-info-item wow fadeInUp col-lg-6 col-12 mb-5" data-wow-delay="1s">
                                ...
                                <div class="contact-info-content">
                                    ...
                                    <p>6 & 7, Prathmesh Leela Building, Ashtavinayak Nagar, Near Sailee Hospital, New
                                        MHB Colony, Boriwali (West), Mumbai - 400091. <br> Contact no - 9320065511
                                    </p>
                                </div>
                            </div>
